			...
			<c:forEach  items="${arrayTirocinioEsterno}" var="tirocinioe">
				<tbody>
					...
					<tr id="numero">
						...
						<td class="text-center"><c:out value="${tirocinioe.ID_Proposta}"></c:out></td>
					</tr>
					<tr>
						<td class="icon"><i class="fa fa-user"></i></td>
						<td class="">Nome e cognome</td>
						<td class="text-center"><c:out value="${utenteLoggato.name}"></c:out> <c:out value="${utenteLoggato.surname}"></c:out></td>
					</tr>
					<tr>
						<td class="icon"><i class="fas fa-at"></i></td>
						<td class="">E-mail</td>
						<td class="text-center"><c:out value="${utenteLoggato.email}"></c:out></td>
					</tr>
					<tr>
						<td class="icon"><i class="fas fa-toggle-on"></i></td>
						<td class="">Status</td>
						<td class="text-center"><c:out value="${tirocinioe.status}"></c:out><i class="far fa-circle"></i></td>
					</tr>
					<tr>
				...
				<tbody>
					<tr id="numero">
						<td class="icon"><i class="fas fa-sort-amount-down"></i></td>
						<td class="">Numero proposta</td>
						<td class="text-center"><c:out value="${tirocinioi.ID_Proposta}"></c:out></td>
					</tr>
					<tr>
						<td class="icon"><i class="fa fa-user"></i></td>
						<td class="">Nome e cognome</td>
					...
					<tr>
						<td class="icon"><i class="fas fa-toggle-on"></i></td>
						<td class="">Status</td>
						<td class="text-center"><c:out value="${tirocinioi.status}"></c:out><i class="far fa-circle"></i></td>
					</tr>
					<tr>
						<td class="icon"><i class="fas fa-circle"></i></td>
						<td class="">Num. CFU</td>
						<td class="text-center"><c:out value="${tirocinioi.NumeroCFU}"></c:out></td>
					</tr>
					<tr>
						<td class="icon"><i class="fas fa-circle"></i></td>
						<td class="">Tipo di tirocinio </td>
