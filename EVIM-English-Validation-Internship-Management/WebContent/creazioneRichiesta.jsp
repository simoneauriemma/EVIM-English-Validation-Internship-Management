				...
				<div class="col-lg-5" id="col-6">
					<div class="scelte">
						<div class="scelta-drop">
							...
							<br>
							<input name="cfu" type="radio" id="radio1" value="6" checked>
							<label id="radio1" for="radio1">6 CFU</label> <br> <input
								name="cfu" type="radio" id="radio2" value="11"> <label
								for="radio2" id="radio2">11 CFU</label> <br> <input
								name="cfu" type="radio" id="radio3" value="17">
							<label for="radio3" id="radio3">17 CFU</label> <br> <input
					...
					<div class="scelta-drop">
						<div class="form-group">
							<label for="sel1"><i class="fas fa-briefcase"></i>
								Seleziona tirocinio</label> <select class="form-control"
								id="sel1" onchange="getTutors(this.value)" name="sel1">
					...
					<div class="scelta-drop">
						<div class="form-group">
							<label for="sel2"><i class="fas fa-building"></i>
								Seleziona azienda</label> <select class="form-control" id="sel2" name="sel2" onchange="getProposteAzienda(this.value)">
					...
					<div class="scelta-drop">
						<div class="form-group">
							<label for="sel4"><i class="fas fa-user"></i> Seleziona
								Tutor Accademico</label> <select class="form-control" id="sel4" name="sel4" onchange="getProposteAccademici(this.value)">
  			...
  			if(xmlHttp.readyState==4 && xmlHttp.status==200)
  				{
  					...
  					var textOptionDefaultSel2=document.createTextNode("Seleziona un'opzione");
  					...
  					var textOptionDefaultSel4=document.createTextNode("Seleziona un'opzione");
  					...
  					nodoTutorAccademici.appendChild(figlioOptionDefaultSel4)
  						...
  						for(var z=0;z<lista[0].TutorAziendali.length;z++)
  						{
  							 	...
  							 	var textOption=document.createTextNode(lista[0].TutorAziendali[z].Nome);
  						...
  						for(var y=0;y<lista[1].TutorAccademici.length;y++)
  						{
							 	...
							 	var textOption=document.createTextNode(lista[1].TutorAccademici[y].Nome);
							 	figlioOption.appendChild(textOption);
  			...
  			if(xmlHttp.readyState==4 && xmlHttp.status==200)
  			{
  					...
  					nodoTutorAccademici.appendChild(figlioOptionDefaultSel4)
  						...
  						for(var y=0;y<lista[0].TutorAccademici.length;y++)
  						{
							 	...
							 	var textOption=document.createTextNode(lista[0].TutorAccademici[y].Nome);
							 	figlioOption.appendChild(textOption);
							 	nodoTutorAccademici.appendChild(figlioOption);
  						}
  			}
	...
	if(stringaTirocinio=="tirocinio1"){
		...
		while(nodoProposte.hasChildNodes()){
			nodoProposte.removeChild(nodoProposte.firstChild);
	  			...
	  			if(xmlHttp.readyState==4 && xmlHttp.status==200)
	  				{
						...
						for(var i in lista.Proposte){
							...
							var textOption=document.createTextNode(lista.Proposte[i].Obiettivo);
							figlioOption.appendChild(textOption);
	  		...
	  		xmlHttp.open("GET","RicercaPropostaAjax?tutor=Azienda&id="+idProposta,true);
	  		xmlHttp.send();
	}
}
	...
	if(stringaTirocinio=="tirocinio2"){
		...
		while(nodoProposte.hasChildNodes()){
			nodoProposte.removeChild(nodoProposte.firstChild);
	  		...
	  		xmlHttp.open("GET","RicercaPropostaAjax?tutor=Accademico&id="+idProposta,true);
	  		xmlHttp.send();
	}
