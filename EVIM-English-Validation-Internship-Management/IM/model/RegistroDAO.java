...
public class RegistroDAO {
	...
	public static boolean doAlterFirmaPdcdEsterno(int idtirocinio) { // per pdcd che approva un
	...
	public static boolean doAlterFirmaPdcdInterno(int idtirocinio) { // per pdcd che approva un
		// registro di tirocinio
		// interno
		boolean result = false;
		try (Connection con = DriverManagerConnectionPool.getConnection()) {
