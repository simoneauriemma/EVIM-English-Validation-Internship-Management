...
INSERT INTO `proposta` (`Obiettivi`,`Competenze`,`Attivita`,`Modalita`,`ID_Azienda`,`ID_Tutor`) VALUES ('I tirocinanti avranno la possibilita di lavorare su digital media, big data, seminari.','Il tirocinio Microsoft Research 2018 sono rivolti ai laurendi in informatica(conoscenza app e web)','Svilippo app e siti web','Quali sono i contenuti e lelogiche di un sistema di controllo di gestione: il sistema direzionale, l�efficacia, l�efficienza, nonch� gli attori in gioco e l\'utilita che reca tale funzione all\'azienda nel suo complesso;',1,2);
INSERT INTO `proposta` (`Obiettivi`,`Competenze`,`Attivita`,`Modalita`,`ID_Azienda`,`ID_Tutor`) VALUES ('I tirocinanti dovranno elaborare algoritmi di gestione delle immagini','I tirocinanti dovranno elaborare algoritmi di gestione delle immagini ','Sviluppo immagini','25 ore settimanali presso ufficio del professore',NULL,1);
INSERT INTO `proposta` (`Obiettivi`,`Competenze`,`Attivita`,`Modalita`,`ID_Azienda`,`ID_Tutor`) VALUES ('I tirocinanti dovranno elaborare algoritmi di biometria','I tirocinanti dovranno elaborare algoritmi di gestione delle immagini','Algoritmi di biometria','25 ore settimanali presso ufficio del professore',NULL,2);